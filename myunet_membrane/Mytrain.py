...
from unet_teacher import MainNet
from mydataset import Mydataset
# from Mydataset_teacher import MKDataset
...
class MyTrain():
    def __init__(self):
        ...
        self.path = r"G:\PyCharmProjects\myunet_membrane\membrane\train"
        self.dataset = Mydataset(self.path)
        # self.dataset = MKDataset(self.path)
        ...
        self.save_modle_path = r"./model/unetv2.pth"
        self.save_img_path = r"./mytrain_img"
    ...
    def Train(self):
        ...
        for j in range(epoch):
            ...
            for i,(img1,img2) in enumerate(self.img_data):
                ...
                target_img = img2[0]
                output_img = output[0]
                img = torch.stack([src_img,target_img,output_img],dim=0)
